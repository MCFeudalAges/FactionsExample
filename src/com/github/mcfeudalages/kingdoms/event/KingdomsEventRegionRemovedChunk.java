...
public class KingdomsEventRegionRemovedChunk extends FactionsEventAbstractSender {
	...
	public KingdomsEventRegionRemovedChunk(CommandSender sender, Region region, PS chunk) {
		super(sender);
		this.region = region;
