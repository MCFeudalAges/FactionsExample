...
public class KingdomsEventRegionClaim extends FactionsEventAbstractSender {
	...
	public KingdomsEventRegionClaim(CommandSender sender, Region region, Faction oldFaction, Faction newFaction) {
		super(sender);
		this.region = region;
